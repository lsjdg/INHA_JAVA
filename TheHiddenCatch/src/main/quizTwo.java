...
public class quizTwo extends JFrame{
    public quizTwo(){
        ...
        JLabel title = new JLabel("JAVA QUIZ #2");
        ...
        JLabel question = new JLabel("True or false?: A function with the access modifier 'default' " +
                "can be shared between files within the same package.");
