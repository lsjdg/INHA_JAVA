...
public class levelTwo extends JFrame {
    ...
    private ArrayList<Range> answers = new ArrayList<Range>() {{
        add(new Range(791,679,981,715));
        add(new Range(291,553,449,618));
        add(new Range(282,565,63,497));
        add(new Range(649,795,1153,838));
        add(new Range(1133,721,1263,740));
        add(new Range(61,489,280,563));
        add(new Range(1499,607,1663,672));
    }};
    ...
    public levelTwo() {
        ...
        addComponentListener(new ComponentAdapter() {
            public void componentResized(ComponentEvent e) {
                ImageIcon imageIcon = new ImageIcon(new ImageIcon("./src/img/level2.jpeg").
